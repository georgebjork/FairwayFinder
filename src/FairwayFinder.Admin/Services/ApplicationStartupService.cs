...
namespace FairwayFinder.Admin.Services;
...
public class ApplicationStartupService : IApplicationStartupService
{
    ...
    public async Task SeedDefaultUserAsync()
    {
        ...
        // Must come after SetEmailAsync — changing the email resets EmailConfirmed to false,
        // and the login page refuses unconfirmed accounts. There is no confirmation flow in the
        // admin console, so a seed user created unconfirmed could never sign in.
